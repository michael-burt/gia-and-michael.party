...
function loadOptions() {
    ...
    e.on("click", function() {
        ...
        }), this.classList.add("is-active"), this == e[0] && this.classList.contains("is-active") ? $(".js-rsvp-show")[0].classList.add("is-active") : $(".js-rsvp-show")[0].classList.remove("is-active")
    })
}
...
function loadForm() {
    var e = document.querySelector(".js-form"),
        ...
        n = (document.querySelector(".js-form-error"), document.querySelector(".js-form-success"));
    t.addEventListener("click", function() {
        ...
        t.classList.add("is-disabled"), t.innerHTML = "Submitting...", t.disabled = !0, $.post("https://example.com/", o, function(t) {
            console.log(t), e.style.display = "none", n.style.display = "block"
        })
    })
}
...
var animate = function() {
    ...
    var t = function(e) {
        ...
        i = {
            ...
            easeOutElastic: function(e, t, n, o) {
                var i = 4 >= arguments.length || void 0 === arguments[4] ? 500 : arguments[4];
                return 0 == e ? t : 1 == (e /= o) ? t + n : (i = o * (1 - Math.min(i, 999) / 1e3), n * Math.pow(2, -10 * e) * Math.sin(2 * (e * o - (n < Math.abs(n) ? i / 4 : i / (2 * Math.PI) * Math.asin(n / n))) * Math.PI / i) + n + t)
            },
        ...
        m = function() {
            ...
            return function(o) {
                return p(o) ? o : (o = n(e, t)(o), "rgb(" + o[0] + ", " + o[1] + ", " + o[2] + ")")
            }
        }(),
        h = function(t) {
            return t = "string" == typeof t ? /^[\#.]?[\w-]+$/.test(t) ? "." == t[0] ? document.getElementsByClassName(t.slice(1)) : "#" == t[0] ? document.getElementById(t.slice(1)) : document.getElementsByTagName(t) : document.querySelectorAll(t) : t, Array.isArray(t) ? t : t.nodeType ? [t] : t instanceof NodeList || t instanceof HTMLCollection ? [].concat(e(t)) : t.get()
        },
        g = new Map;
    "el delay begin complete loop direction".split(" ").forEach(function(e) {
        return g.set(e, null)
    }), g.set("duration", 1e3), g.set("easing", "easeOutElastic");
    var v = function() {
            ...
            var e = n(r, p),
                o = t(function(t, n) {
                    var o = t.get(n).map(F),
                        ...
                        r = o[1],
                        o = new Map;
                    return o.set("prop", n), o.set("from", i), o.set("to", r), o.set("isTransformFunction", S(n)), o.set("isColor", e(t.get(n))), /\d$/.test(t.get("easing")) ? (i = t.get("easing").split(" "), r = i[1], o.set("easing", i[0]), o.set("frequency", r)) : o.set("easing", t.get("easing")), o
                });
            return function(e) {
                return C(e).map(o(e))
            }
    ...
    var S = function() {
        ...
        F = function() {
            ...
            return function(t) {
                var n = new Map;
                return n.set("digits", ("string" == typeof t ? t : String(t)).match(e).map(Number)), n.set("others", ("string" == typeof t ? t : String(t)).split(e)), n
            }
        }(),
        L = t(function(e, t, n) {
        ...
        R = function() {
            ...
            return t(function(t, n, o) {
                ...
                t.forEach(function(e, t) {
                    e.get("isTransformFunction") ? (i || (i = []), i.push(e.get("prop") + "(" + n[t] + ")")) : "opacity" == e.get("prop") ? o.style.opacity = n[t] : o.setAttribute(e.get("prop"), n[t])
                }), i && (e || (e = "transform" in document.body.style ? "transform" : "-webkit-transform"), o.style[e] = i.join(" "))
            })
        }(),
        P = function() {
            var e = function(e, t) {
        ...
        Z = function(e) {
            ...
            A(t), P(function e(r) {
                if (z.has(o)) {
                    i.has("start") || i.set("start", r), i.set("elapsed", r - i.get("start")), r = i.get("elapsed") < t.get("duration");
                    var a = n.map(r ? L(t, i.get("elapsed")) : _(t));
                    z.get(o).forEach(R(n, a)), r ? requestAnimationFrame(e) : (r = d(z), r["delete"](o), z = r, t.get("complete") && t.get("complete")(t.get("el")), t.get("loop") && B(t))
                }
            }, t)
        };
...
var yall = function() {
    ...
    return function(t) {
        var n = {
            ...
            s = function(e) {
                ...
                "VIDEO" === e.tagName && (a(e.querySelectorAll("source")).forEach(function(e) {
                    return l(e)
                }), l(e), !0 === e.autoplay && e.load()), "IFRAME" === e.tagName && l(e), e.classList.contains(o.lazyBackgroundClass) && (e.classList.remove(o.lazyBackgroundClass), e.classList.add(o.lazyBackgroundLoaded))
            },
            l = function(e) {
                null !== e.getAttribute("data-srcset") && e.setAttribute("srcset", e.getAttribute("data-srcset")), null !== e.getAttribute("data-src") && e.setAttribute("src", e.getAttribute("data-src")), null !== e.getAttribute("data-poster") && e.setAttribute("poster", e.getAttribute("data-poster"))
            },
            u = function e() {
                var t = !1;
                !1 === t && c.length > 0 && (t = !0, setTimeout(function() {
                    c.forEach(function(e) {
                        e.getBoundingClientRect().top <= window.innerHeight + o.threshold && e.getBoundingClientRect().bottom >= -o.threshold && "none" !== getComputedStyle(e).display && (!0 === o.idlyLoad && !0 === n.idleCallbackSupport ? requestIdleCallback(function() {
                            s(e)
                        }, r) : s(e), e.classList.remove(o.lazyClass), c = c.filter(function(t) {
                            return t !== e
                        }))
                    }), t = !1, 0 === c.length && !1 === o.observeChanges && n.eventsToBind.forEach(function(t) {
                ...
                e.forEach(function(e) {
                    if (!0 === e.isIntersecting || e.intersectionRatio > 0) {
                        ...
                        !0 === o.idlyLoad && !0 === n.idleCallbackSupport ? requestIdleCallback(function() {
                            return s(i)
                        }, r) : s(i), i.classList.remove(o.lazyClass), t.unobserve(i), c = c.filter(function(e) {
                            return e !== i
                        })
                    }
                })
        ...
        } else n.eventsToBind.forEach(function(e) {
        ...
        !0 === n.mutationObserverSupport && !0 === o.observeChanges && new MutationObserver(function(e) {
            return e.forEach(function() {
                a(document.querySelectorAll(i)).forEach(function(e) {
                    -1 === c.indexOf(e) && (c.push(e), !0 === n.intersectionObserverSupport ? d.observe(e) : u())
                })
            })
...
! function(e, t) {
    ...
    "use strict";
    return function(e, t) {
        var n, o, i, r, a, s, l, u, c, d, f, p, m, h, g, v, y, w, x, b = this,
            I = !1,
            C = !0,
            E = !0,
            O = {
            ...
            T = function(e) {
                ...
                for (var n, o, i = e.target || e.srcElement, r = i.getAttribute("class") || "", a = 0; a < K.length; a++) n = K[a], n.onTap && r.indexOf("pswp__" + n.name) > -1 && (n.onTap(), o = !0);
                if (o) {
            ...
            F = function(t) {
                ...
                return e.shout("shareLinkClick", t, n), !(!n.href || !n.hasAttribute("download") && (window.open(n.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), E || D(), 1))
            },
            L = function() {
                for (var e, t, n, o, i, r = "", a = 0; a < g.shareButtons.length; a++) e = g.shareButtons[a], n = g.getImageURLForShare(e), o = g.getPageURLForShare(e), i = g.getTextForShare(e), t = e.url.replace("{{url}}", encodeURIComponent(o)).replace("{{image_url}}", encodeURIComponent(n)).replace("{{raw_image_url}}", n).replace("{{text}}", encodeURIComponent(i)), r += '<a href="' + t + '" target="_blank" class="pswp__share--' + e.id + '"' + (e.download ? "download" : "") + ">" + e.label + "</a>", g.parseShareButtonOut && (r = g.parseShareButtonOut(e, r));
            ...
            $ = function(e) {
                ...
                if (M()) {
                    ...
                    if (g.captionEl && "auto" === a.bottom)
                        if (r || (r = t.createEl("pswp__caption pswp__caption--fake"), r.appendChild(t.createEl("pswp__caption__center")), o.insertBefore(r, i), t.addClass(o, "pswp__ui--fit")), g.addCaptionHTMLFn(e, r, !0)) {
            ...
            q = function() {
                g.timeToIdle && d("mouseUsed", function() {
                    t.bind(document, "mousemove", P), t.bind(document, "mouseout", B), w = setInterval(function() {
                        2 === ++R && b.setIdle(!0)
                    }, g.timeToIdle / 2)
                })
            },
                ...
                var e, n, i, r = function(o) {
                    if (o)
                        for (var r = o.length, a = 0; a < r; a++) {
                            e = o[a], n = e.className;
                            for (var s = 0; s < K.length; s++) i = K[s], n.indexOf("pswp__" + i.name) > -1 && (g[i.option] ? (t.removeClass(e, "pswp__element--disabled"), i.onInit && i.onInit(e)) : t.addClass(e, "pswp__element--disabled"))
                        }
                };
                r(o.children);
        ...
        b.init = function() {
            t.extend(e.options, O, !0), g = e.options, o = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen, U(), d("beforeChange", b.update), d("doubleTap", function(t) {
                ...
                t.bind(o, "pswpTap click", T), t.bind(e.scrollWrap, "pswpTap", b.onGlobalTap), e.likelyTouchDevice || t.bind(e.scrollWrap, "mouseover", b.onMouseOver)
            }), d("unbindEvents", function() {
                E || D(), w && clearInterval(w), t.unbind(document, "mouseout", B), t.unbind(document, "mousemove", P), t.unbind(o, "pswpTap click", T), t.unbind(e.scrollWrap, "pswpTap", b.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", b.onMouseOver), n && (t.unbind(document, n.eventK, b.updateFullscreen), n.isFullscreen() && (g.hideAnimationDuration = 0, n.exit()), n = null)
            }), d("destroy", function() {
                g.captionEl && (r && o.removeChild(r), t.removeClass(i, "pswp__caption--empty")), l && (l.children[0].onclick = null), t.removeClass(o, "pswp__ui--over-close"), t.addClass(o, "pswp__ui--hidden"), b.setIdle(!1)
            }), g.showAnimationDuration || t.removeClass(o, "pswp__ui--hidden"), d("initialZoomIn", function() {
                g.showAnimationDuration && t.removeClass(o, "pswp__ui--hidden")
            }), d("initialZoomOut", function() {
                t.addClass(o, "pswp__ui--hidden")
            }), d("parseVerticalMargin", $), H(), g.shareEl && s && l && (E = !0), S(), q(), z(), N()
        }, b.setIdle = function(e) {
            c = e, k(o, "ui--idle", e)
        }, b.update = function() {
            C && e.currItem ? (b.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(e.currItem, i), k(i, "caption--empty", !e.currItem.title)), I = !0) : I = !1, E || D(), S()
            ...
            if (!v)
                ...
                } else if (g.tapToToggleControls && (C ? b.hideControls() : b.showControls()), g.tapToClose && (t.hasClass(o, "pswp__img") || _(o))) return void e.close()
    ...
    return function(e, t, n, o) {
            ...
            detectFeatures: function() {
                ...
                if (o.oldIE = document.all && !document.addEventListener, o.touch = "ontouchstart" in window, window.requestAnimationFrame && (o.raf = window.requestAnimationFrame, o.caf = window.cancelAnimationFrame), o.pointerEvent = !!window.PointerEvent || navigator.msPointerEnabled, !o.pointerEvent) {
                    ...
                    var s = r.match(/Android\s([0-9\.]*)/),
                        l = s ? s[1] : 0;
                    l = parseFloat(l), l >= 1 && (l < 4.4 && (o.isOldAndroid = !0), o.androidVersion = l), o.isMobileOpera = /opera mini|opera mobi/i.test(r)
                }
        ...
        var u, c, d, f, p, m, h, g, v, y, w, x, b, I, C, E, O, T, M, k, S, A, D, F, L, _, R, P, B, z, N, Z, $, q, U, K, H, Y, W, G, j, X, V, Q, J, ee, te, ne, oe, ie, re, ae, se, le, ue, ce, de, fe = function() {
            ...
            Fe = function(e, t, n, o, i) {
                (!Ee || i && i !== r.currItem) && (o /= i ? i.fitRatio : r.currItem.fitRatio), e[A] = x + t + "px, " + n + "px" + b + " scale(" + o + ")"
            },
            Le = function(e) {
                ie && (e && (y > r.currItem.fitRatio ? Ee || (pn(r.currItem, !1, !0), Ee = !0) : Ee && (pn(r.currItem), Ee = !1)), Fe(ie, he.x, he.y, y))
            },
            _e = function(e) {
            ...
            Ze = null,
            $e = function() {
                Ze && (i.unbind(document, "mousemove", $e), i.addClass(e, "pswp--has_mouse"), l.mouseUsed = !0, Se("mouseUsed")), Ze = setTimeout(function() {
                    Ze = null
                }, 100)
            },
            qe = function() {
                i.bind(document, "keydown", r), N.transform && i.bind(r.scrollWrap, "click", r), l.mouseUsed || i.bind(document, "mousemove", $e), i.bind(window, "resize scroll orientationchange", r), Se("bindEvents")
            },
            Ue = function() {
                i.unbind(window, "resize scroll orientationchange", r), i.unbind(window, "scroll", v.scroll), i.unbind(document, "keydown", r), i.unbind(document, "mousemove", $e), N.transform && i.unbind(r.scrollWrap, "click", r), W && i.unbind(window, h, r), clearTimeout(Z), Se("unbindEvents")
            },
            Ke = function(e, t) {
            ...
            We = function(e, t, n, o) {
                return o === r.currItem.initialZoomLevel ? (n[e] = r.currItem.initialPosition[e], !0) : (n[e] = Be(e, o), n[e] > t.min[e] ? (n[e] = t.min[e], !0) : n[e] < t.max[e] && (n[e] = t.max[e], !0))
            },
            Ge = function() {
                if (A) {
                ...
                A = "left", i.addClass(e, "pswp--ie"), Re = function(e, t) {
                    t.left = e + "px"
                }, _e = function(e) {
            ...
            it = {
                ...
                init: function() {
                    if (!u && !c) {
                        var n;
                        r.framework = i, r.template = e, r.bg = i.getChildByClass(e, "pswp__bg"), R = e.className, u = !0, N = i.detectFeatures(), L = N.raf, _ = N.caf, A = N.transform, B = N.oldIE, r.scrollWrap = i.getChildByClass(e, "pswp__scroll-wrap"), r.container = i.getChildByClass(r.scrollWrap, "pswp__container"), p = r.container.style, r.itemHolders = E = [{
                            ...
                            wrap: 0,
                            index: -1
                        }], E[0].el.style.display = E[2].el.style.display = "none", Ge(), v = {
                            resize: r.updateSize,
                        ...
                        for (N.animationName && N.transform && !o || (l.showAnimationDuration = l.hideAnimationDuration = 0), n = 0; n < Ie.length; n++) r["init" + Ie[n]]();
                        if (t) {
                            (r.ui = new t(r, i)).init()
                        }
                        Se("firstUpdate"), f = f || l.index || 0, (isNaN(f) || f < 0 || f >= en()) && (f = 0), r.currItem = Jt(f), (N.isOldIOSPhone || N.isOldAndroid) && (be = !1), e.setAttribute("aria-hidden", "false"), l.modal && (be ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = i.getScrollY() + "px")), void 0 === z && (Se("initialLayout"), z = P = i.getScrollY());
                        var a = "pswp--open ";
                        for (l.mainClass && (a += l.mainClass + " "), l.showHideOpacity && (a += "pswp--animate_opacity "), a += F ? "pswp--touch" : "pswp--notouch", a += N.animationName ? " pswp--css_animation" : "", a += N.svg ? " pswp--svg" : "", i.addClass(e, a), r.updateSize(), m = -1, xe = null, n = 0; n < s; n++) Re((n + m) * we.x, E[n].el.style);
                        B || i.bind(r.scrollWrap, g, r), ke("initialZoomInEnd", function() {
                            r.setContent(E[0], f - 1), r.setContent(E[2], f + 1), E[0].el.style.display = E[2].el.style.display = "block", l.focus && e.focus(), qe()
                        }), r.setContent(E[1], f), r.updateCurrItem(), Se("afterInit"), be || (I = setInterval(function() {
                            Je || W || ee || y !== r.currItem.initialZoomLevel || r.updateSize()
                        }, 1e3)), i.addClass(e, "pswp--visible")
                    }
                },
                close: function() {
                    u && (u = !1, c = !0, Se("close"), Ue(), nn(r.currItem, null, !0, r.destroy))
                },
                destroy: function() {
                    Se("destroy"), jt && clearTimeout(jt), e.setAttribute("aria-hidden", "true"), e.className = R, I && clearInterval(I), i.unbind(r.scrollWrap, g, r), i.unbind(window, "scroll", r), Ot(), nt(), Me = null
                },
                panTo: function(e, t, n) {
                    n || (e > oe.min.x ? e = oe.min.x : e < oe.max.x && (e = oe.max.x), t > oe.min.y ? t = oe.min.y : t < oe.max.y && (t = oe.max.y)), he.x = e, he.y = t, Le()
                },
                ...
                goTo: function(e) {
                    e = Te(e);
                    var t = e - f;
                    xe = t, f = e, r.currItem = Jt(f), ve -= t, Pe(we.x * ve), nt(), re = !1, r.updateCurrItem()
                },
                next: function() {
                    r.goTo(f + 1)
                },
                ...
                updateCurrZoomItem: function(e) {
                    ...
                    oe = r.currItem.bounds, w = y = r.currItem.initialZoomLevel, he.x = oe.center.x, he.y = oe.center.y, e && Se("afterChange")
                },
                ...
                updateCurrItem: function(e) {
                    if (0 !== xe) {
                        var t, n = Math.abs(xe);
                        if (!(e && n < 2)) {
                            r.currItem = Jt(f), Ee = !1, Se("beforeChange", xe), n >= s && (m += xe + (xe > 0 ? -s : s), n = s);
                            for (var o = 0; o < n; o++) xe > 0 ? (t = E.shift(), E[s - 1] = t, m++, Re((m + 2) * we.x, t.el.style), r.setContent(t, f - n + o + 1 + 1)) : (t = E.pop(), E.unshift(t), m--, Re(m * we.x, t.el.style), r.setContent(t, f + n - o - 1 - 1));
                            if (ie && 1 === Math.abs(xe)) {
                                var i = Jt(O);
                ...
                updateSize: function(t) {
                    ...
                    if (ge.x = r.scrollWrap.clientWidth, ge.y = r.scrollWrap.clientHeight, Ve(), we.x = ge.x + Math.round(ge.x * l.spacing), we.y = ge.y, Pe(we.x * ve), Se("beforeResize"), void 0 !== m) {
                        for (var o, a, u, c = 0; c < s; c++) o = E[c], Re((c + m) * we.x, o.el.style), u = f + c - 1, l.loop && en() > 2 && (u = Te(u)), a = Jt(u), a && (C || a.needsUpdate || !a.bounds) ? (r.cleanSlide(a), r.setContent(o, u), 1 === c && (r.currItem = a, r.updateCurrZoomItem(!0)), a.needsUpdate = !1) : -1 === o.index && u >= 0 && r.setContent(o, u), a && a.container && (un(a, ge), pn(a), _e(a));
                        C = !1
                    }
                    w = y = r.currItem.initialZoomLevel, oe = r.currItem.bounds, oe && (he.x = oe.center.x, he.y = oe.center.y, Le(!0)), Se("resize")
                },
                zoomTo: function(e, t, n, o, r) {
                    t && (w = y, xt.x = Math.abs(t.x) - he.x, xt.y = Math.abs(t.y) - he.y, ze(me, he));
                    var a = Ke(e, !1),
                        s = {};
                    ...
                    Ne(s);
                    var c = function(t) {
                        1 === t ? (y = e, he.x = s.x, he.y = s.y) : (y = (e - l) * t + l, he.x = (s.x - u.x) * t + u.x, he.y = (s.y - u.y) * t + u.y), r && r(t), Le(1 === t)
                    };
            ...
            zt = function(e) {
                ...
                })) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Bt[0] = Dt(e.touches[0], Rt), e.touches.length > 1 && (Bt[1] = Dt(e.touches[1], Pt))) : (Rt.x = e.pageX, Rt.y = e.pageY, Rt.id = "", Bt[0] = Rt), Bt
            },
            Nt = function(e, t) {
                var n, o, i, a, s = he[e] + t[e],
                    u = t[e] > 0,
                    c = wt.x + t.x,
                    d = wt.x - pt.x;
                return n = s > oe.min[e] || s < oe.max[e] ? l.panEndFriction : 1, s = he[e] + t[e] * n, !l.allowPanToNext && y !== r.currItem.initialZoomLevel || (ie ? "h" !== ae || "x" !== e || j || (u ? (s > oe.min[e] && (n = l.panEndFriction, oe.min[e] - s, o = oe.min[e] - me[e]), (o <= 0 || d < 0) && en() > 1 ? (a = c, d < 0 && c > pt.x && (a = pt.x)) : oe.min.x !== oe.max.x && (i = s)) : (s < oe.max[e] && (n = l.panEndFriction, s - oe.max[e], o = me[e] - oe.max[e]), (o <= 0 || d > 0) && en() > 1 ? (a = c, d > 0 && c < pt.x && (a = pt.x)) : oe.min.x !== oe.max.x && (i = s))) : a = c, "x" !== e) ? void(re || Q || y > r.currItem.fitRatio && (he[e] += t[e] * n)) : (void 0 !== a && (Pe(a, !0), Q = a !== pt.x), oe.min.x !== oe.max.x && (void 0 !== i ? he.x = i : Q || (he.x += t.x * n)), void 0 !== a)
            },
            Zt = function(e) {
                if (!("mousedown" === e.type && e.button > 0)) {
                    ...
                    if (!Y || "mousedown" !== e.type) {
                        ...
                        var n = zt(e),
                            o = n.length;
                        J = null, nt(), W && 1 !== o || (W = se = !0, i.bind(window, h, r), K = ce = le = H = Q = X = G = j = !1, ae = null, Se("firstTouchStart", n), ze(me, he), pe.x = pe.y = 0, ze(ct, n[0]), ze(dt, ct), pt.x = we.x * ve, mt = [{
                            x: ct.x,
                            y: ct.y
                        }], q = $ = Ae(), Ke(y, !0), Ot(), Tt()), !ee && o > 1 && !re && !Q && (w = y, j = !1, ee = G = !0, pe.y = pe.x = 0, ze(me, he), ze(st, n[0]), ze(lt, n[1]), Ft(st, lt, bt), xt.x = Math.abs(bt.x) - he.x, xt.y = Math.abs(bt.y) - he.y, te = ne = Et(st, lt))
                    }
                }
            },
            $t = function(e) {
            ...
            qt = function() {
                if (J) {
                    var e = J.length;
                    if (0 !== e)
                        if (ze(st, J[0]), ut.x = st.x - ct.x, ut.y = st.y - ct.y, ee && e > 1) {
                            if (ct.x = st.x, ct.y = st.y, !ut.x && !ut.y && It(J[1], lt)) return;
                            ...
                            o < 0 && (o = 0), te = t, Ft(st, lt, vt), pe.x += vt.x - bt.x, pe.y += vt.y - bt.y, ze(bt, vt), he.x = Be("x", n), he.y = Be("y", n), K = n > y, y = n, Le()
                        } else {
                            if (!ae) return;
            ...
            Ut = function(e) {
                ...
                1 === u && ze(dt, s[0]), 0 !== u || ae || re || (t || ("mouseup" === e.type ? t = {
                    x: e.pageX,
                    y: e.pageY,
                    type: "mouse"
                ...
                var c = -1;
                if (0 === u && (W = !1, i.unbind(window, h, r), Ot(), ee ? c = 0 : -1 !== yt && (c = Ae() - yt)), yt = 1 === u ? Ae() : -1, a = -1 !== c && c < 150 ? "zoom" : "swipe", ee && u < 2 && (ee = !1, 1 === u && (a = "zoomPointerUp"), Se("zoomGestureEnded")), J = null, X || j || re || H)
                    if (nt(), U || (U = Kt()), U.calculateSwipeSpeed("x"), H) {
                        ...
                        if (d < l.verticalDragRange) r.close();
                            ...
                            ot("verticalDrag", 0, 1, 300, i.easing.cubic.out, function(e) {
                                he.y = (r.currItem.initialPosition.y - f) * e + f, De((1 - p) * e + p), Le()
                            }), Se("onVerticalDrag", 1)
                        }
                    } else {
                        if ((Q || re) && 0 === u) {
                        ...
                        if (!re) return "swipe" !== a ? void Gt() : void(!Q && y > r.currItem.fitRatio && Ht(U))
                    }
            },
            Kt = function() {
                var e, t, n = {
                    ...
                    calculateSwipeSpeed: function(o) {
                        mt.length > 1 ? (e = Ae() - q + 50, t = mt[mt.length - 2][o]) : (e = Ae() - $, t = dt[o]), n.lastFlickOffset[o] = ct[o] - t, n.lastFlickDist[o] = Math.abs(n.lastFlickOffset[o]), n.lastFlickDist[o] > 20 ? n.lastFlickSpeed[o] = n.lastFlickOffset[o] / e : n.lastFlickSpeed[o] = 0, Math.abs(n.lastFlickSpeed[o]) < .1 && (n.lastFlickSpeed[o] = 0), n.slowDownRatio[o] = .95, n.slowDownRatioReverse[o] = 1 - n.slowDownRatio[o], n.speedDecelerationRatio[o] = 1
                    },
            ...
            Yt = function(e, t) {
                ...
                var u;
                o && (f += o, f < 0 ? (f = l.loop ? en() - 1 : 0, u = !0) : f >= en() && (f = l.loop ? 0 : en() - 1, u = !0), u && !l.loop || (xe += o, ve -= o, n = !0));
                var c, d = we.x * ve,
                    p = Math.abs(d - wt.x);
                return n || d > wt.x == t.lastFlickSpeed.x > 0 ? (c = Math.abs(t.lastFlickSpeed.x) > 0 ? p / Math.abs(t.lastFlickSpeed.x) : 333, c = Math.min(c, 400), c = Math.max(c, 250)) : c = 333, gt === f && (n = !1), re = !0, Se("mainScrollAnimStart"), ot("mainScroll", wt.x, d, c, i.easing.cubic.out, Pe, function() {
                    nt(), re = !1, gt = -1, (n || gt !== f) && r.updateCurrItem(), Se("mainScrollAnimComplete")
            ...
            Gt = function() {
                ...
                y < t ? e = t : y > n && (e = n);
                var o, a = ue;
                return le && !K && !ce && y < t ? (r.close(), !0) : (le && (o = function(e) {
                    De((1 - a) * e + a)
        ...
        Oe("Gestures", {
            publicMethods: {
                initGestures: function() {
                    ...
                    D = N.pointerEvent, D && N.touch && (N.touch = !1), D ? navigator.msPointerEnabled ? e("MSPointer", "Down", "Move", "Up", "Cancel") : e("pointer", "down", "move", "up", "cancel") : N.touch ? (e("touch", "start", "move", "end", "cancel"), F = !0) : e("mouse", "down", "move", "up"), h = M + " " + k + " " + S, g = T, D && !F && (F = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), r.likelyTouchDevice = F, v[T] = Zt, v[M] = $t, v[k] = Ut, S && (v[S] = v[k]), N.touch && (g += " mousedown", h += " mousemove mouseup", v.mousedown = v[T], v.mousemove = v[M], v.mouseup = v[k]), F || (l.allowPanToNext = !1)
                }
            }
        });
        var jt, Xt, Vt, Qt, Jt, en, tn, nn = function(t, n, o, a) {
                ...
                var u = o ? l.hideAnimationDuration : l.showAnimationDuration,
                    c = function() {
                        et("initialZoom"), o ? (r.template.removeAttribute("style"), r.bg.removeAttribute("style")) : (De(1), n && (n.style.display = "block"), i.addClass(e, "pswp--animated-in"), Se("initialZoom" + (o ? "OutEnd" : "InEnd"))), a && a(), Qt = !1
                    };
                if (!u || !s || void 0 === s.x) return Se("initialZoom" + (o ? "Out" : "In")), y = t.initialZoomLevel, ze(he, t.initialPosition), Le(), e.style.opacity = o ? 0 : 1, De(1), void(u ? setTimeout(function() {
                    c()
                }, u) : c());
                ! function() {
                    var n = d,
                        a = !r.currItem.src || r.currItem.loadError || l.showHideOpacity;
                    t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), o || (y = s.w / t.w, he.x = s.x, he.y = s.y - P, r[a ? "template" : "bg"].style.opacity = .001, Le()), tt("initialZoom"), o && !n && i.removeClass(e, "pswp--animated-in"), a && (o ? i[(n ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function() {
                        ...
                        if (Se("initialZoom" + (o ? "Out" : "In")), o) {
                            var r = s.w / t.w,
                                ...
                                f = ue,
                                p = function(t) {
                                    1 === t ? (y = r, he.x = s.x, he.y = s.y - z) : (y = (r - d) * t + d, he.x = (s.x - l.x) * t + l.x, he.y = (s.y - z - l.y) * t + l.y), Le(), a ? e.style.opacity = 1 - t : De(f - t * f)
                                };
                            n ? ot("initialZoom", 0, 1, u, i.easing.cubic.out, p, c) : (p(1), jt = setTimeout(c, u + 20))
                        } else y = t.initialZoomLevel, ze(he, t.initialPosition), Le(), De(1), a ? e.style.opacity = 1 : De(1), jt = setTimeout(c, u + 20)
                    }, o ? 25 : 90)
                }()
            },
            on = {},
            ...
            un = function(e, t, n) {
                if (e.src && !e.loadError) {
                    ...
                    if (o && (e.vGap || (e.vGap = {
                            top: 0,
                            bottom: 0
                        }), Se("parseVerticalMargin", e)), on.x = t.x, on.y = t.y - e.vGap.top - e.vGap.bottom, o) {
                        var i = on.x / e.w,
                            r = on.y / e.h;
                        e.fitRatio = i < r ? i : r;
                        var a = l.scaleMode;
            ...
            cn = function(e, t, n, o, i, a) {
                t.loadError || o && (t.imageAppended = !0, pn(t, o, t === r.currItem && Ee), n.appendChild(o), a && setTimeout(function() {
        ...
        Oe("Controller", {
            publicMethods: {
                lazyLoadItem: function(e) {
                    e = Te(e);
                    var t = Jt(e);
                    t && (!t.loaded && !t.loading || C) && (Se("gettingData", e, t), t.src && dn(t))
                },
                initController: function() {
                    i.extend(l, an, !0), r.items = Xt = n, Jt = r.getItemAt, en = l.getNumItemsFn, tn = l.loop, en() < 3 && (l.loop = !1), ke("beforeChange", function(e) {
                        var t, n = l.preload,
                            o = null === e || e >= 0,
                            i = Math.min(n[0], en()),
                            a = Math.min(n[1], en());
                    ...
                    }), ke("mainScrollAnimComplete", mn), ke("initialZoomInEnd", mn), ke("destroy", function() {
                ...
                setContent: function(e, t) {
                    ...
                    if (!a.src && a.html && (a.html.tagName ? s.appendChild(a.html) : s.innerHTML = a.html), fn(a), un(a, ge), !a.src || a.loadError || a.loaded) a.src && !a.loadError && (o = i.createEl("pswp__img", "img"), o.style.opacity = 1, o.src = a.src, pn(a, o), cn(t, a, s, o, !0));
                    else {
                        if (a.loadComplete = function(n) {
                                if (u) {
                                    if (e && e.index === t) {
                                        if (fn(n, !0)) return n.loadComplete = n.img = null, un(n, ge), _e(n), void(e.index === f && r.updateCurrZoomItem());
                                        n.imageAppended ? !Qt && n.placeholder && (n.placeholder.style.display = "none", n.placeholder = null) : N.transform && (re || Qt) ? rn.push({
                                            item: n,
                                            baseDiv: s,
                                            img: n.img,
                                            index: t,
                        ...
                        a.loading || dn(a), r.allowProgressiveImg() && (!Vt && N.transform ? rn.push({
                            item: a,
                            baseDiv: s,
                            img: a.img,
                            index: t,
                    ...
                    Vt || t !== f ? _e(a) : (ie = s.style, nn(a, o || a.img)), e.el.innerHTML = "", e.el.appendChild(s)
                },
        ...
        Oe("Tap", {
            publicMethods: {
                ...
                onTapRelease: function(e, t) {
                    if (t && !X && !G && !Je) {
                        var n = t;
                        if (hn && (clearTimeout(hn), hn = null, Ct(n, gn))) return void Se("doubleTap", n);
                        ...
                        ze(gn, n), hn = setTimeout(function() {
                            vn(e, t), hn = null
                        }, 300)
                    }
                }
        ...
        Oe("DesktopZoom", {
            publicMethods: {
                ...
                setupDesktopZoom: function(t) {
                    ...
                    var o, a = function() {
                            r.mouseZoomedIn && (i.removeClass(e, "pswp--zoomed-in"), r.mouseZoomedIn = !1), y < 1 ? i.addClass(e, "pswp--zoom-allowed") : i.removeClass(e, "pswp--zoom-allowed"), s()
                        },
                        s = function() {
                ...
                handleMouseWheel: function(e) {
                    if (y <= r.currItem.fitRatio) return l.modal && (!l.closeOnScroll || Je || W ? e.preventDefault() : A && Math.abs(e.deltaY) > 2 && (d = !0, r.close())), !0;
                    ...
                    var t = he.x - yn.x,
                        n = he.y - yn.y;
                    (l.modal || t <= oe.min.x && t >= oe.max.x && n <= oe.min.y && n >= oe.max.y) && e.preventDefault(), r.panTo(t, n)
                },
        ...
        var wn, xn, bn, In, Cn, En, On, Tn, Mn, kn, Sn, An, Dn = {
            ...
            Rn = function() {
                if (bn && clearTimeout(bn), Je || W) return void(bn = setTimeout(Rn, 500));
                ...
                An ? "#" + n !== window.location.hash && history[Tn ? "replaceState" : "pushState"]("", document.title, o) : Tn ? Sn.replace(o) : Sn.hash = n, Tn = !0, xn = setTimeout(function() {
                    In = !1
                }, 60)
            };
        Oe("History", {
            publicMethods: {
                initHistory: function() {
                    if (i.extend(l, Dn, !0), l.history) {
                        Sn = window.location, kn = !1, Mn = !1, Tn = !1, On = Fn(), An = "pushState" in history, On.indexOf("gid=") > -1 && (On = On.split("&gid=")[0], On = On.split("?gid=")[0]), ke("afterChange", r.updateURL), ke("unbindEvents", function() {
                            i.unbind(window, "hashchange", r.onHashChange)
                        });
                        var e = function() {
                            En = !0, Mn || (kn ? history.back() : On ? Sn.hash = On : An ? history.pushState("", document.title, Sn.pathname + Sn.search) : Sn.hash = ""), Ln()
                        };
                        ke("unbindEvents", function() {
                            d && e()
                        }), ke("destroy", function() {
                        ...
                        t > -1 && (On = On.substring(0, t), "&" === On.slice(-1) && (On = On.slice(0, -1))), setTimeout(function() {
                            u && i.bind(window, "hashchange", r.onHashChange)
                        }, 40)
                    }
                },
                onHashChange: function() {
                    return Fn() === On ? (Mn = !0, void r.close()) : void(In || (Cn = !0, r.goTo(_n().pid), Cn = !1))
                },
                updateURL: function() {
...
var isMobile = window.matchMedia("(max-width: 640px)").matches,
    initPhotoSwipeFromDOM = function(e) {
        for (var t = function(e) {
                for (var t, n, o, i, r = e.childNodes, a = r.length, s = [], l = 0; l < a; l++) t = r[l], 1 === t.nodeType && (n = t.children[0], o = n.getAttribute("data-size").split("x"), i = {
                ...
                isNaN(a.index) || (o && (a.showAnimationDuration = 0), r = new PhotoSwipe(l, PhotoSwipeUI_Default, s, a), r.init(), r.listen("afterChange", function() {
                    var e = (r.getCurrentIndex(), r.currItem.el),
                        t = e.offsetLeft - e.parentNode.offsetLeft - 5;
                    e.parentNode.scrollLeft = t
                }))
            }, a = document.querySelectorAll(e), s = 0, l = a.length; s < l; s++) a[s].setAttribute("data-pswp-uid", s + 1), a[s].onclick = o;
        var u = i();
...
document.body.classList.contains("index") && (yall({
    ...
    loadNav()
}, 3500)), document.body.classList.contains("save-the-date") && setTimeout(function() {
    startAnimation()
}, 1200), document.body.classList.contains("slideshow") && initPhotoSwipeFromDOM(".js-gallery");
